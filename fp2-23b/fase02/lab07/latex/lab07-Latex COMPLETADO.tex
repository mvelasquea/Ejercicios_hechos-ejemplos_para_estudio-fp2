	 ...
	 public static void main(String[] args) {
	    ...
	    public static void ordenarSoldadosPorBurbuja(ArrayList<Soldado> ejercito) {
	        ...
	        for (int i = 0; i < n - 1; i++) {
				...
				\end{lstlisting}
\includegraphics[scale=1]{../../Proyecto/fp2-23b/fase02/lab07/latex/img/captura 1.PNG} 

\item segunda captura
\includegraphics[scale=1]{../../Proyecto/fp2-23b/fase02/lab07/latex/img/Captura 2.PNG} 			
