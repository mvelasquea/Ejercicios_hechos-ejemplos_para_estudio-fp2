...
/*
	...
	\end{lstlisting}
\subsection{EJERCICIO 02 (Uso de arreglos de objetos en el ejercicio 4 del lab 01)}
	\begin{itemize}	
		\item Se crea la clase Soldado.
		\item Se crea la clase principal:
	\end{itemize}	
---------------------------------------------------------
	...
	\end{lstlisting}	   
------------------------------------------------------------	
	\begin{lstlisting}[language=bash,caption={Creando la clase PRINCIPPAL_soldados}][H]
